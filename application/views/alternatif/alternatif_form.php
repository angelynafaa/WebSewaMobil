...
<div class="row">
	...
	<div class="form-group required">
		<label class="col-sm-2 control-label" for="">Nama Client</label>
		<div class="col-md-10">
			<select name="id_client" class="form-control">
				...
				if (!empty($client)) {
					foreach ($client as $s) {
			 	?>
			 	<option value='<?php echo $s->id_client ?>'><?php echo $s->nama_client ?></option>
			 	<?php }}else{ ?>
				<option class="form-control"> Semua client sudah terdaftar</option>
			 	<?php } ?>
			</select>
		</div>
	</div>
